<template>
  <div class="app-container">
    ...
    <div slot="footer" class="dialog-footer" style="float:right">
      <el-button v-if="hasPerm('footer.update')" type="primary" @click="updateHtml">保存</el-button>
      <el-button v-if="hasPerm('footer.update')" type="primary" @click="defaultHtml">重置</el-button>
    </div>
  </div>
</template>
<script>
